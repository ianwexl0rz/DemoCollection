	...
	UnityLight light, UnityIndirect gi, half lightDist, half lightRadius)
{
    ...
    // TODO: Use normal alpha and/or hardness factor to modify style
    // Custom lighting
    half diffuseTermModified = smoothstep(0.2, 0.8, diffuseTerm);
    diffuseTerm = lerp(diffuseTerm, diffuseTermModified, 1);

    //half smoothness = oneMinusRoughness;
