Shader /*ase_name*/ "Hidden/Lightweight Stylized SSS" /*end*/
{
    Properties
    {
		/*ase_props*/
        ...
        Pass
        {
			...
			*/
        	...
        	half4 frag (GraphVertexOutput IN /*ase_frag_input*/ ) : SV_Target
            {
				...
				SSSData sssData;
				sssData.color = /*ase_frag_out:Subsurface Color;Float3;12*/float3(1, 0, 0)/*end*/;
				sssData.thickness = /*ase_frag_out:SSS Depth;Float;13*/0/*end*/;
				sssData.ambient = /*ase_frag_out:SSS Ambient;Float;14*/0/*end*/;
