...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Lightweight Stylized", false, 85 )]
		public static void ApplyTemplate10()
		{
			AmplifyShaderEditorWindow.CreateNewTemplateShader( "de67b7cd207a38a488ea6f1165d4614b" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/Lightweight Stylized SSS", false, 85 )]
		public static void ApplyTemplate11()
		{
			AmplifyShaderEditorWindow.CreateNewTemplateShader( "8b9f256ee9f233b4884967b1182825ad" );
		}
	}
}
